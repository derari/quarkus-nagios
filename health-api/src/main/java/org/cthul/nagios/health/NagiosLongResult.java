...
public record NagiosLongResult(
    ...
    public NagiosLongResult(String name, long value, String unit, AlertRange warningRange, AlertRange criticalRange, Map<String, Object> data, boolean exportPerformance) {
        this(name, value, unit, AlertRange.ALLOW_ALL.getStatus(value, warningRange, criticalRange), warningRange, criticalRange, data, exportPerformance);
    }
